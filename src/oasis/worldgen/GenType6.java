...
class GenType6 {
	 ...
	 */
	public static void generate(WorldGen plugin, Player player, int radius, String namePerm, String nameDisplay, String nameClass, String nameFID, int Offset) {
		...
		try {
			...
			WorldInterface i = new WorldInterface(plugin, player, "WorldGenVillageStart");
			...
			if(nameFID.equalsIgnoreCase("village blacksmith") || nameFID.equalsIgnoreCase("village house")){
				GenType6Sub1(oBuild,clBuild,nameFID);
			}
	...
	private static void GenType6Sub1(Object oBuild, Class<?> clBuild, String nameFID) throws IllegalArgumentException, IllegalAccessException, SecurityException, NoSuchFieldException{
